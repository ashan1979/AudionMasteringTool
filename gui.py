...
class MasteringApp:
    def __init__(self, root):
        ...
        self.clip_cb = tk.Checkbutton(root, text="Enable Soft Clipper (Warmth)", variable=self.use_clipper)
        self.clip_cb.pack(pady=5)
    ...
    def run_mastering(self):
        ...
        def task():
            ...
            self.status_label.config(text="Status: Mastering Audio...", fg="orange")
            try:
